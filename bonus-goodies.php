...
<head>
	...
	<title>Goodies de Showtime</title>
	<meta name="description" content="La liste BDE showtime vous offre ses goodies">
...
<!--fin-menu-->
	...
	<div id="main" role="main">
		<div id="container-body"><?php include'includes/bonus-goodies.php'?></div>
	</div><!-- #end of main -->
