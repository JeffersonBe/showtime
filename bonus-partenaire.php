...
<head>
	...
	<title>Tous les sponsors de la liste BDE Showtime</title>
	<meta name="description" content="La liste BDE showtime vous présente ses sponsors">
...
<!--fin-menu-->
	...
	<div id="main" role="main">
		<div id="container-body"><?php include'includes/bonus-partenaire.php'?></div>
	</div><!-- #end of main -->
