...
<head>
	...
	<title> Showtime BDE 2012/2013 de TM&SP!</title>
	<meta name="description" content="Le BDE Showtime présente son site internet">
	<?php include'includes/header.php'?>
</head>
	<body>
		<div id="barre-header" class="row">
			<?php include'includes/barre-header.php';?>
		</div>
			<div id="container">
				<div id="header">
			...
			<?php include'includes/navigation.php'?>
				<div id="main" role="main">
					<div id="accueil"><?php include'includes/accueil.php'?></div>
				</div><!-- #end of main -->				
