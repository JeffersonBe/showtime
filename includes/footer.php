...
<div id="myModal" class="reveal-modal">
    <div class="row">
        <div class="twelve columns three-up">
            ...
            <div class="four columns mobile-two">
                <a class="zimbra" href="https://z.mines-telecom.fr/" title="Consulte tes mails avec Zimbra !">
                    <p class="text-center no-margin"><i class="extra-large-icons foundicon-mail"></i></p>
                    <p class="text-center">Zimbra</p>
                </a>
            </div>
